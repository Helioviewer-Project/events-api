...
class JSOC
{
    ...
    /**
     * Fetch data for a specific HARP number with date range from JSOC.
     *
    ...
    public function fetchByHarpNumberWithDateRange(int $harpNumber, string $date, int $days = 5): ?array
    {
        ...
        echo "DEBUG: JSOC fetchByHarpNumberWithDateRange URL:\n";
        echo "  " . urldecode($url) . "\n\n";
    ...
    /**
     * Fetch data for a specific NOAA Active Region number from JSOC.
     *
    ...
    public function fetchByNoaaNumber(int $noaaNumber, string $date, int $days = 5): ?array
    {
        ...
        echo "DEBUG: JSOC fetchByNoaaNumber URL:\n";
        echo "  " . urldecode($url) . "\n\n";
    ...
    public function fetchNoaaActiveRegions(int $noaaNumber): ?array
    {
        ...
        echo "DEBUG: JSOC fetchNoaaActiveRegions URL:\n";
        echo "  " . urldecode($url) . "\n\n";
        
        echo "Querying JSOC NOAA Active Regions for NOAA AR {$noaaNumber}...\n";
        echo "URL: \"" . urldecode($url) . "\"\n\n";
        ...
        try {
            ...
            echo "Found {$recordCount} NOAA AR records for {$noaaNumber}\n";
            ...
            echo "Exception in fetchNoaaActiveRegions for NOAA AR {$noaaNumber}: " . $e->getMessage() . "\n";
            throw new \Exception("Failed to fetch NOAA AR {$noaaNumber} from JSOC: " . $e->getMessage());
        }
    }
